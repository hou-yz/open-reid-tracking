...
CUDA_VISIBLE_DEVICES=2,3 python3 IDE_triplet.py --train -d dukemtmc --logs-dir logs/ide_triplet/fc256/dukemtmc/basis --height 384 -s 1 --features 256 --output_feature fc --mygt_fps 1 --fix_bn 0 --re 0.5 --combine-trainval
