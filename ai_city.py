...
class AI_City(object):
    ...
    def __init__(self, root, type='reid', iCams=list(range(1, 41)), fps=1, trainval=False):
        if type == 'ai_gt':
            # if not trainval:
            train_dir = '~/Data/AI_City_Challenge/ALL_gt_bbox/train'
            # else:
            #     train_dir = '~/Data/DukeMTMC/ALL_gt_bbox/trainval'
            val_dir = '~/Data/AI_City_Chanllenge/ALL_gt_bbox/test'
