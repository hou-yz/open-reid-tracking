...
# det feat
#CUDA_VISIBLE_DEVICES=3 python3 save_cnn_feature.py  -a ide --resume logs/ide_new/256/duke_my_gt/train/1_fps/basis/model_best.pth.tar --features 256 --output_feature fc --l0_name ide_basis_train_1fps -s 1 --height 384 -d detections --det_time trainval
# gt feat
CUDA_VISIBLE_DEVICES=2,3 python3 save_cnn_feature.py -b 128 -a ide --resume logs/ide_new/256/duke_my_gt/train/1_fps/basis/model_best.pth.tar --features 256 --output_feature fc --l0_name ide_basis_train_1fps -s 1 --height 384 -d gt_all --det_time trainval